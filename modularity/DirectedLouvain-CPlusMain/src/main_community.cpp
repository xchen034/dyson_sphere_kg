...
usage(char *prog_name, const char *more) {
        cerr << more;
        cerr << "usage: " << prog_name << " input_file [-w weight_file] [-p part_file] [-q epsilon] [-l display_level] [-s seed] [-v] [-h]" << endl << endl;
        ...
        cerr << "-s seed\tthe reandom seed to set." << endl;
...
main(int argc, char **argv) {
        ...
        do {
                ...
                improvement = c.one_level(set_seed=set_seed, seed=seed);
